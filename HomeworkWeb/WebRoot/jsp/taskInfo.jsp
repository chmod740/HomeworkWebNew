...
<script type="text/javascript">
      ...
      function uploadFile() {
        ...
        xhr.open("POST", "fileUpload.action");//修改成自己的接口
        xhr.send(fd);
      }
		...
		<div class="jumbotron" style="position:relative; top:50px;">
			...
			<%if(adminFlag == false){ %>
				...
				<form enctype="multipart/form-data" method="post" action="fileUpload.action">
					...
					<input id="fileToUpload" type="file" name="file" class="btn btn-danger btn-lg" onchange="fileSelected();"> <br>
					<input type="button" onclick="uploadFile()" class="btn  btn-danger btn-lg btn-block" style="width:325px;" value="提交作业&nbsp;&raquo;&raquo;&raquo;">
					 <div id="fileName"></div>
    					<div id="fileSize"></div>
    				<div id="fileType"></div>
